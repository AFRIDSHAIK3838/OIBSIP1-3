...
public class ExamManagement {
	...
	public void userlogin() {
		details.put("Afrid", 3838);
		System.out.println(
				"\n\n ---------------------------- WELCOME TO ONLINE EXAM PORTAL ----------------------------");
		String username;
		int password;
		System.out.print("Enter The Registered Name : ");
		username = sc.next();
	...
	public void exam() {
		...
		while (System.currentTimeMillis() < finishTime || sn < x) {
			String i = a6.get(sn);
			System.out.println("\n\nQ." + (sn + 1) + ") " + i);
			System.out.println("\n(1) " + questions.get(i).get(0) + "\t" + "(2) " + questions.get(i).get(1) + "\t"
					+ "(3) " + questions.get(i).get(2) + "\t" + "(4) " + questions.get(i).get(3) + " ");
